...
class arithmeticExpression{
 ...
 private:
    ...
    /*Helper function for buildTree that allows recursive call. Returns a node after dynamically allocating
    new node based on equation and assigning the right and left pointers*/
    TreeNode* buildTreeRecursive(string & , char &);

    /* Helper function for destructor that allows recursive call. Passes in a node to delete */
