...
class BSTree {
    private:
        ...
        /*returns node of the parent node*/
        Node* GetParent(Node* , Node*);
        /* Find and return the first node found matching the string */
        Node* searchNode(Node* , const string &key) const;
        /*helper function for search function*/
        bool searchRecursive(Node* , const string &key) const;
